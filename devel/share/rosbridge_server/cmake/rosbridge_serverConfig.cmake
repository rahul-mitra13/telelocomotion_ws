...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_server_SOURCE_PREFIX /home/lab/telelocomotion_ws/src/rosbridge_suite/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX /home/lab/telelocomotion_ws/devel)
  ...
  set(rosbridge_server_INSTALL_PREFIX /home/lab/telelocomotion_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/rosbridge_server " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/rosbridge_server' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lab/telelocomotion_ws/src/rosbridge_suite/rosbridge_server/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosbridge_server_dep}_FOUND)
      find_package(${rosbridge_server_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosbridge_server_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
